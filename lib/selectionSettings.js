...
(function () {
  ...
  var selectionSettings = function () {
    const _self = this;
    $(`${this.containerSelector} .main-panel`).append(`<div class="toolpanel" id="select-panel"><div class="content"><p class="title">Configuracion de la seleccion</p></div></div>`);
    ...
    (() => {
      $(`${this.containerSelector} .toolpanel#select-panel .content`).append(`
        <div class="text-section">
          ...
          <div class="sizes">
            <div class="input-container"><label>Tamaño de la fuente</label>
            ...
            <div class="input-container"><label>Grosor</label>
              <div class="custom-number-input">
              <button class="decrease">-</button>
            ...
            <div class="input-container"><label>Espaciado entre letras</label>
              <div class="custom-number-input">
              <button class="decrease">-</button>
          ...
          <div class="align">
            <div class="input-container">
            <label>Alineacion del texto</label>
    ...
    (() => {
      $(`${this.containerSelector} .toolpanel#select-panel .content`).append(`
        <div class="border-section">
          <h4>Borde</h4>
          <div class="input-container"><label>Anchura</label>
            <div class="custom-number-input">
            <button class="decrease">-</button>
          ...
          <div class="input-container"><label>Tipo de borde</label><select id="input-corner-type"><option value="miter" selected>Square</option><option value="round">Round</option></select></div>
    ...
    (() => {
      $(`${this.containerSelector} .toolpanel#select-panel .content`).append(`
        <div class="fill-section">
          ...
          <div class="tabs">
            <div class="tab-label" data-value="color-fill">Relleno solido</div>
            <div class="tab-label" data-value="gradient-fill">Relleno de gradiente</div>
          </div>
